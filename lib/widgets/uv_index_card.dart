...
class UVIndexCard extends StatelessWidget {
  ...
  double _barPos(double uv) => (uv / 11).clamp(0.0, 1.0);
  ...
  Widget build(BuildContext context) {
    ...
    final barPos = uv != null ? _barPos(uv) : 0.0;
          ...
          child: Column(
            ...
            children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Icon(Icons.north_east, size: 10, color: AppTheme.textMuted(isDark)),
              ]),
              const SizedBox(height: 5),
              Text(uv != null ? uv.toStringAsFixed(0) : '--',
              ...
              SizedBox(
                ...
                child: Stack(clipBehavior: Clip.none, alignment: Alignment.centerLeft, children: [
                  Positioned.fill(top: 3, bottom: 3,
                  ...
                  Align(
                    ...
                    child: Container(width: 8, height: 8,
                      decoration: BoxDecoration(
                        color: isDark ? const Color(0xFF0d1a0f) : Colors.white,
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Text('Peak:', style: TextStyle(fontSize: 8.5, color: AppTheme.textMuted(isDark))),
                Text('12:00–15:00', style: TextStyle(
                    fontSize: 8.5, color: AppTheme.textSecondary(isDark), fontWeight: FontWeight.w500)),
              ]),
            ],
          ),
        ),
